...
def add_question():
    ...
    new_wrong1 = menu_wrong1_edit.text()
    new_wrong2 = menu_wrong2_edit.text()
    new_wrong3 = menu_wrong3_edit.text()
...
def clear_menu():
    ...
    menu_wrong1_edit.clear()
    menu_wrong2_edit.clear()
    menu_wrong3_edit.clear()
